...
public class Server {
    ...
    private boolean processCommand(String message, long clientId){
        ...
        if(message.equalsIgnoreCase("disconnect")){
            ...
            StringBuilder sb = new StringBuilder(message.replace("reverse ", ""));
            sb.reverse();
            ...
            while (it.hasNext()) {
                ...
                if(client.getId() == clientId){
                    ...
                    boolean wasSuccessful = client.send(rev);
            ...
            System.out.println("From Client: " + message);
            StringBuilder sb = new StringBuilder(message.replace("shuffle ", ""));
            String result = jumble(sb.toString());
            ...
            while (it.hasNext()) {
                ...
                if(client.getId() == clientId){
                    ...
                    boolean wasSuccessful = client.send(result);
            ...
            while (it.hasNext()) {
                ...
                if(client.getId() == clientId){
                    ...
                    boolean wasSuccessful = client.send(tossResult[index]);
